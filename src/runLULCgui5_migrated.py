...
class MyForm(QtWidgets.QMainWindow):
    ...
    def initModelParam(self):
        self.__demand=None # TODO Python Function
        self.__modelNAValue=None # TODO Python Function
        self.__MASKFile=None # TODO Python Function
        self.__AOIFile=None # TODO Python Function
        self.__suitabilityFileDirectory=None # TODO Python Function
...
#Object name is suffiexed by the driver number and row no is less than one of that
    ...
    def on_pbNext_DriverSelectionT0_clicked(self):
        getClassNum = R.r['getClassNumber'] #TODO Python Function
...
#####
    ...
    def prepareSpatialData(self):
        ...
        if(self.ui.cbEnable_DemandAllocationSpatialContext.checkState()):
            ...
            self.__neughbourl=R.IntVector(self.__neughbourl) #TODO Python Function
        else:
            self.__neughbourl=None #TODO Python Function
    ...
    def prepareClassName(self):
        ...
        self.__className=R.StrVector(self.__className) #TODO Python Function
    ...
    def prepareDemand(self):
        ...
        if(self.ui.cbUserDefinedDemand_DemandAllocation.isChecked()):
            ...
            self.__demand=R.IntVector(self.__demand) #TODO Python Function
    ...
    def prepareInertia(self):
        ...
        if(self.ui.cbUserDefinedClassInertia_DemandAllocation.isChecked()):
            ...
            self.__restricSpatial=R.FloatVector(self.__restricSpatial) #TODO Python Function
        else:
            self.__restricSpatial=None #TODO Python Function
    ...
    def prepareConversionOrder(self):
        if(self.ui.rbUserDefined_ModelAnalysisMigrationOrder.isChecked()):
            ...
            self.__conversionOrder=R.r.matrix(R.IntVector(self.__conversionOrder), nrow=noOfClass) #TODO Python Function
        else:
    ...
    def prepareClassAllocationOrder(self):
        ...
        if(self.ui.cbclassallocation_DemandAllocation.isChecked()):
            ...
            self.__classAllocationOrder=R.IntVector(self.__classAllocationOrder) #TODO Python Function

        else:
            self.__classAllocationOrder=None #TODO Python Function
    ...
    def prepareReferenceFile(self):
        ...
        if(len(name)!=0):
            ...
            self.__ReferenceFile=None #TODO Python Function
    ...
    def runRCommand(self):
        ...
        sink=R.r['sink'] #TODO Python Function
        sink(path)
        genMap = R.r['genratePredictedMap'] #TODO Python Function
        genMap(modelType=R.StrVector(self.__modeltype),
                   T1File=self.__T0File,
                   T2File=self.__T1File,
                   withClassName=self.__className,
                   T1drivers=R.ListVector(self.__DriverDictionaryT1), #TODO Python Function
                   T2drivers=R.ListVector(self.__DriverDictionaryT2), #TODO Python Function
                   withNAvalue=self.__modelNAValue,
                   demand=self.__demand,
                   restrictSpatialMigration=self.__restricSpatial,
                   AllowedClassMigration=None, #TODO Python Function
                   conversionOrder=self.__conversionOrder,
                   classAllocationOrder=None, #TODO Python Function
                   neighbour=self.__neughbourl,
                   method="NotIncludeCurrentClass",
                   modelformula=R.StrVector(self.__modelformula), #TODO Python Function
    ...
    def on_actionSave_File_triggered(self):
        ...
        if (self.__AOIFile!=None): #TODO Python Function
            pk.write("AOIFile=\"%s\"\n"%(str(self.__AOIFile)))
        else:
            pk.write("AOIFile=NA\n")
        if (self.__MASKFile!=None): #TODO Python Function
            pk.write("mymaskFile=\"%s\"\n"%(str(self.__MASKFile)))
        else:
            pk.write("mymaskFile=NA\n")
        pk.write("T1File=\"%s\"\n"%(str(self.__T0File)))
        pk.write("T2File=\"%s\"\n"%(str(self.__T1File)))
        if (self.__ReferenceFile!=None): #TODO Python Function
        ...
        if (self.__restricSpatial!=None): #TODO Python Function
        ...
        for i in list(range(len(self.__className))):
            if(i!=len(self.__className)-1):
                ...
                pk.write("\"%s\""%(self.__className[i]))
        pk.write(")\n")
        if (self.__demand!=None): #TODO Python Function
        ...
        if (self.__modelNAValue!=None): #TODO Python Function
            pk.write("na.value=%s\n"%(str(self.__modelNAValue)))
        else:
            pk.write("na.value=NA\n")

        if (self.__neughbourl!=None): #TODO Python Function
        ...
        if (self.__classAllocationOrder!=None): #TODO Python Function
        ...
        if (self.__suitabilityFileDirectory!=None): #TODO Python Function
    ...
    def calculateStatistics(self):
        print('kappa')
        runRFun = R.r['createTM'] #TODO Python Function
        ...
        #tm=runRFun('/home/akjha/GUITEST/cvcvxv.tif','/home/akjha/GUITEST/cvcvxv.tif',None)#Run R coammnd
        tm=runRFun(actualFile,predictedFile,None) #TODO Python Function
        runRFun = R.r['kappa'] #TODO Python Function
        kappa=runRFun(tm)
        runRFun=R.r['PyKappasummary'] #TODO Python Function
        kappasummary=runRFun(kappa)
        print(kappasummary)
        path=os.path.join(str(self.__projectDirectory),self.currentLogTime+'-accuracy.log')        
        sink=R.r['sink'] #TODO Python Function
        sink(path) 
        R.r['print'](tm) #TODO Python Function
        R.r['print'](kappasummary) #TODO Python Function
        sink=R.r['sink'] #TODO Python Function
        sink()            
...
######
    ...
    def getLegendClassName(self):
        ...
        return(R.StrVector(names)) #TODO Python Function
    ...
    def getLegendClassValue(self):
       # if (self.__noOfClasses==0):
        ...
        #    self.__className=classDN
        return(R.IntVector(classDN)) #TODO Python Function

    def prepareTempPng(self,pF,pT,pL,cNo,cN,cC,wTP):
        import tempfile
        from rpy2.robjects.packages import importr
        genMapp = R.r['genrateMap'] #TODO Python Function
    ...
    def prepareR(self):
        ...
        R.r(self.rcode) #TODO Python Function
        ...
        CheckInstallPackage = R.r['CheckInstallPackage'] #TODO Python Function
        #code="packages="+libs
        CheckInstallPackage(libs)

    def releaseR(self): 
        rquit=R.r['quit'] #TODO Python Function
        rquit("no",0)
    ...
    def getColorPallet(self):
        ...
        newp= R.StrVector(newp) #TODO Python Function
        return(newp)
